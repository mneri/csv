...
public final class Rfc4180HalfRelaxedFormat implements Format {
    ...
    // *                    ,                    \r                   \n                   "                    EOF                  padding
       ...
       ERR|ERH,             BFF|EFB,             CAR|EFB,             BFL|EFB|ELH,         QOT|RMB,             EOF|EFB|ELH|RPL,     0,0,  // ESC
       ERR|ERH,             BFF|SFH|EFH,         CAR|SFH|EFH,         BFL|SFH|EFH|ELH,     QOT|SFH,             EOF|SFH|EFH|ELH|RPL, 0,0,  // SQE
    ...
    /**
     * Return a provider of {@code Rfc4180HalfRelaxedFormat}.
     *
     * @return The provider.
     */
